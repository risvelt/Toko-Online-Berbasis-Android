...
import com.example.appsepatu.view.history.RiwayatActivity
import com.example.appsepatu.view.input.InputDataActivity
import com.example.appsepatu.view.jenis.JenisSepatuActivity
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setInitLayout() {
        ...
        cvKategori.setOnClickListener { v: View? ->
            val intent = Intent(this@MainActivity, JenisSepatuActivity::class.java)
            startActivity(intent)
        }
