...
import com.example.appsepatu.utils.FunctionHelper
import com.example.appsepatu.view.history.RiwayatAdapter.RiwayatAdapterCallback
import com.example.appsepatu.viewmodel.RiwayatViewModel
...
class RiwayatActivity : AppCompatActivity(), RiwayatAdapterCallback {
    ...
    private fun setViewModel() {
        riwayatViewModel = ViewModelProvider(this, ViewModelProvider.AndroidViewModelFactory.getInstance(this.application)).get(RiwayatViewModel::class.java)
